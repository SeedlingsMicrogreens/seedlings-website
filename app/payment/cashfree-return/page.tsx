import CashfreeReturnHydrator from '@/components/CashfreeReturnHydrator';

export default function Page() {
  return (
    <CashfreeReturnHydrator>
      <main>
        <section className="auth-wrap">
          <div className="auth-card" data-payment-result style={{ textAlign: 'center' }}>
            ...
            <p data-payment-order className="muted" style={{ marginTop: 10 }}></p>
            <p data-payment-orders className="muted" style={{ marginTop: 6 }}></p>
