...
export default function JourneyPage() {
  return <>
    <Header navItems={[]} />
    <main>
      <section className="page-hero"><div className="container"><div className="breadcrumbs"><a href="/">Home</a> / Journey</div><h1>Our Journey</h1><p>From seed to plate, every step is guided by freshness, care and the goal of bringing living nutrition closer to your table.</p></div></section>
